...
sample.list <- list("w08_male_merged_CpG_evidence.cov", "w08_queen_merged_CpG_evidence.cov",
                    ...
                    "w23_male_merged_CpG_evidence.cov", "w23_queen_merged_CpG_evidence.cov",
...
CPGRaw <- methRead(sample.list, 
                   sample.id = list("w08_male","w08_queen","w19_male","w19_queen",
                                    "w23_male", "w23_queen","w37_male","w37_queen"),
                   assembly="bter_1.0",
...
nrow(meth_all_data) 
# 24 for all data (N genome) ... increased to 168
# cross 1:1218 (N genome) ... 6091
# cross 2:767 (N genome) ... 4883
...
#covariates <- data.frame(colony=c("08","08","19","19","23","23","37","37"))
covariates <- data.frame(colony=c("08","08","19","19"))
covariates <- data.frame(colony=c("23","23","37","37"))
