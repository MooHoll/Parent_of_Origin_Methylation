...
/scratch/monoallelic/hjm31/bin_new/Bismark-0.22.3/bismark --multicore 3 --non_bs_mm \
/scratch/monoallelic/hjm31/bumblebee/genome/N_masked/08_genome \
 -1 trim_w08_1.fq.gz -2 trim_w08_2.fq.gz

/scratch/monoallelic/hjm31/bin_new/Bismark-0.22.3/bismark --multicore 3 --non_bs_mm \
/scratch/monoallelic/hjm31/bumblebee/genome/N_masked/19_genome \
 -1 trim_w19_1.fq.gz -2 trim_w19_2.fq.gz
 
/scratch/monoallelic/hjm31/bin_new/Bismark-0.22.3/bismark --multicore 3 --non_bs_mm \
/scratch/monoallelic/hjm31/bumblebee/genome/N_masked/23_genome \
 -1 trim_w23_1.fq.gz -2 trim_w23_2.fq.gz

/scratch/monoallelic/hjm31/bin_new/Bismark-0.22.3/bismark --multicore 3 --non_bs_mm \
/scratch/monoallelic/hjm31/bumblebee/genome/N_masked/37_genome \
